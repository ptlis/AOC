...
class Day4Test {
    ...
    fun testParseCardData() {
        ...
        assertEquals(expected, parseCardData("Card 1: 41 48 83 86 17 | 83 86  6 31 17  9 48 53"))
    }
    ...
    fun testExamplePart1Sum() {
        ...
        """.trimIndent().lines().map { parseCardData(it) }

        assertEquals(expected, scratchcards.sumOf { it.points })
    }
    ...
    fun testExamplePart2() {
        ...
        assertEquals(expected, calculateScratchcardCount(scratchcards))
    }
}
