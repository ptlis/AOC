...
class CompletedSolutionsTest: FunSpec({
    ...
    val completedSolutions = listOf(
        ...
        CompletedSolution(Day4Year2024(), BigInteger.valueOf(2397), BigInteger.valueOf(1824)),
        CompletedSolution(Day5Year2024(), BigInteger.valueOf(5091), BigInteger.valueOf(-1)),
        CompletedSolution(Day6Year2024(), BigInteger.valueOf(-1), BigInteger.valueOf(-1)),
    )
